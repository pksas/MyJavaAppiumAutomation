...
public class CoreTestCase extends TestCase {
    ...
    protected void setUp() throws Exception
    {
        ...
        activeDriverAccordingPlatformEnv(capabilities);
    ...
    private void activeDriverAccordingPlatformEnv(DesiredCapabilities capabilities) throws Exception
    {
        String platform = System.getenv("PLATFORM");
        if (platform.equals(PLATFORM_ANDROID)) {
            ...
            throw new Exception("Cannot active driver for platform from env variable Platform value " + platform);
        }
    }
}
